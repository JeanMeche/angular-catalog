...
export class CommunesService {
     ...
     */
    public communesCodeGet(requestParameters: CommunesCodeGetRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CommuneBE>;
    public communesCodeGet(requestParameters: CommunesCodeGetRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CommuneBE>>;
    public communesCodeGet(requestParameters: CommunesCodeGetRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CommuneBE>>;
    public communesCodeGet(requestParameters: CommunesCodeGetRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<CommuneBE>(`${this.configuration.basePath}/communes/${encodeURIComponent(String(code))}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public communesGet(requestParameters: CommunesGetRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<CommuneBE>>;
    public communesGet(requestParameters: CommunesGetRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<CommuneBE>>>;
    public communesGet(requestParameters: CommunesGetRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<CommuneBE>>>;
    public communesGet(requestParameters: CommunesGetRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (codeDepartement !== undefined && codeDepartement !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>codeDepartement, 'codeDepartement');
        }
