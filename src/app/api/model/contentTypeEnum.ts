 ...
 * TSP for TechSpecs
 */
export type ContentTypeEnumBE = 'TSP' | 'MSG' | 'SYS' | 'LOG' | 'PIC' | 'IMG' | 'DOC' | 'OTH' | 'LNK' | 'HST' | 'VID' | 'MDA' | 'RC';

export const ContentTypeEnumBE = {
    Tsp: 'TSP' as ContentTypeEnumBE,
    Msg: 'MSG' as ContentTypeEnumBE,
    Sys: 'SYS' as ContentTypeEnumBE,
    Log: 'LOG' as ContentTypeEnumBE,
    Pic: 'PIC' as ContentTypeEnumBE,
    Img: 'IMG' as ContentTypeEnumBE,
    Doc: 'DOC' as ContentTypeEnumBE,
    Oth: 'OTH' as ContentTypeEnumBE,
    Lnk: 'LNK' as ContentTypeEnumBE,
    Hst: 'HST' as ContentTypeEnumBE,
    Vid: 'VID' as ContentTypeEnumBE,
    Mda: 'MDA' as ContentTypeEnumBE,
    Rc: 'RC' as ContentTypeEnumBE
};
