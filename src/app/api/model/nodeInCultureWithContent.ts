...
import { NodeContentsBE } from './nodeContents';
import { NodeInCultureWithContentAllOfBE } from './nodeInCultureWithContentAllOf';
import { BasePathNodeBE } from './basePathNode';
import { StatusEnumBE } from './statusEnum';


export interface NodeInCultureWithContentBE { 
    oid: number;
    name: string;
