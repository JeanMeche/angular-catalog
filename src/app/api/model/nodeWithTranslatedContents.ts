 ...
 */
import { NodeInCultureBE } from './nodeInCulture';
import { NodeWithTranslatedContentsAllOfBE } from './nodeWithTranslatedContentsAllOf';
import { BasePathNodeBE } from './basePathNode';
import { NodeTranslationBE } from './nodeTranslation';
import { StatusEnumBE } from './statusEnum';


export interface NodeWithTranslatedContentsBE { 
    oid: number;
    name: string;
    ...
    status: Array<StatusEnumBE>;
    cultureCode: string;
    translations: { [key: string]: NodeTranslationBE; };
}
